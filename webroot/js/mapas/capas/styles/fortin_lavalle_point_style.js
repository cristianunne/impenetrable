...
function style_fortinlavalle_0_0() {
    return {
        interactive: true,
    }
}

function tooltip_fortinlavalle_point(feature) {
...
function showPopupFortinlavallePOI(feature)
{
    getDataFromFortinlavallePOI(feature);
}

function getDataFromFortinlavallePOI(feature)
{
    //console.log(feature);
...
function onEachFeaturegetDataFromFortinlavallePOIPoint(feature, layer)
{
    layer.on({
        click: null,
        mouseover: showPopupFortinlavallePOI
    });
    let popupContent_ = tooltip_fortinlavalle_point(feature);
...
var layer_fortin_lavalle_point = new L.geoJson(fortin_lavalle_point, {
    attribution: '',
    interactive: false,
    minZoom: 10,
    dataVar: 'fortin_lavalle_point',
    layerName: 'layer_fortin_lavalle_point',
    onEachFeature: onEachFeaturegetDataFromFortinlavallePOIPoint,
