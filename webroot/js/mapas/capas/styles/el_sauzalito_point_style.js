...
function style_elsauzalito_0_0() {
    return {
        interactive: true,
    }
}

function tooltip_elsauzalito_point(feature) {
...
function showPopupElSauzalitoPOI(feature)
{
    getDataFromElSauzalitoPOI(feature);
}

function getDataFromElSauzalitoPOI(feature)
{
    //console.log(feature);
...
function onEachFeaturegetDataFromElSauzalitoPOIPoint(feature, layer)
{
    layer.on({
        click: null,
        mouseover: showPopupElSauzalitoPOI
    });
    let popupContent_ = tooltip_elsauzalito_point(feature);
...
var layer_el_sauzalito_point = new L.geoJson(el_sauzalito_point, {
    attribution: '',
    interactive: false,
    minZoom: 10,
    dataVar: 'layer_el_sauzalito_point',
    layerName: 'layer_el_sauzalito_point',
    onEachFeature: onEachFeaturegetDataFromElSauzalitoPOIPoint,
