...
function tooltip_villariobermejito_point(feature) {
...
function showPopupVillariobermejitoPOI(feature)
{
    getDataFromVillariobermejitoPOI(feature);
}

function getDataFromVillariobermejitoPOI(feature)
{
    //console.log(feature);
...
function onEachFeatureVillariobermejitoPoint(feature, layer)
{
    layer.on({
        click: null,
        mouseover: showPopupVillariobermejitoPOI(feature)
    });
    let popupContent_ = tooltip_villariobermejito_point(feature);
...
var layer_villa_rio_bermejito_point = new L.geoJson(villa_rio_bermejito_point, {
    attribution: '',
    interactive: false,
    minZoom: 10,
    dataVar: 'villa_rio_bermejito_point',
    layerName: 'layer_villa_rio_bermejito_point',
