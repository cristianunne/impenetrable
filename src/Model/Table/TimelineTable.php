 ...
 * @method \App\Model\Entity\Timeline|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Timeline saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
