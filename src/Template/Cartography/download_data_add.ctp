            ...
            <div class="col-lg-5 center-div">
                ...
                <?=  $this->Html->image('centro_descargas.svg', ['alt' => 'Centro de Descarga', 'class' => 'img-fluid img-landing-box wow zoomIn']); ?>
                    <div class="box-header">
                        <h5 class="box-title" style="color: rgb(0 38 6 / 96.3%);">Agregar nueva Descarga</h5>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group login-form-gruop">
                            ...
                            <?= $this->Form->input('geometria', ['type' => 'select', 'multiple' => false, 'options' => ['Punto','Línea','Polígono'], 'empty' => true, 'class' => 'form-control form-select', 'placeholder' => '', 'label' => false, 'required']) ?>
                        </div>
                        <div class="form-group login-form-gruop">
                            <label for="nombre" class="cols-sm-2 control-label fw-bold">Nombre: </label>
                            <?= $this->Form->input('nombre', ['type' => 'text', 'class' => 'form-control', 'placeholder' => '', 'label' => false, 'required']) ?>
                        </div>
